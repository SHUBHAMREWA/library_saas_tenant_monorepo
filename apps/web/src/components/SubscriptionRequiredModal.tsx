...
export const SubscriptionRequiredModal: React.FC<SubscriptionRequiredModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white text-slate-900 rounded-3xl w-full max-w-md p-6 shadow-2xl border border-slate-200 [color-scheme:light] relative overflow-hidden">
        {/* Glow Header */}
        ...
        <div className="mt-4">
          ...
          <p className="text-xs text-slate-500 mt-1.5 leading-relaxed">
            Creating libraries, rooms, and seat layouts is <strong className="text-slate-700">100% free</strong>.
